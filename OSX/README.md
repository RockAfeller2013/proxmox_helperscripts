...
qm create 110 --name "proxmox-vm" --memory 32000 --cores 2 --net0 virtio,bridge=vmbr0 --scsihw virtio-scsi-pci --ostype l26 --scsi0 local-lvm:60 --ide2 local:iso/proxmox-ve-8.4.iso,media=cdrom --boot order=ide2```
