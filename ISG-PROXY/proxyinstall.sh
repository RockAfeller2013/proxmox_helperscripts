...
# bash -c "$(curl -fsSL -H "Cache-Control: no-cache" -H "Pragma: no-cache" -H "Expires: 0" https://raw.githubusercontent.com/RockAfeller2013/proxmox_helperscripts/refs/heads/main/ISG-PROXY/proxyinstall.sh)" -- \
500 /mnt/synology-backups/ISG-Proxy/ProxySG-SWG-KVM-Enterprise/ProxySG_SWG_KVM_303757.qcow2 local-lvm ISG-PROXY 32000 2
